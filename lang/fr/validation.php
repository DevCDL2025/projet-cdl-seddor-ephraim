...
return [
    ...
    'attributes'           => [
        ...
        'code'                      => 'code',
        'rate'                      => 'taux',
        'departure_currency'        => "devise de départ",
        'arrival_currency'          => "devise d'arrivée",
        'abbreviation'              => "abréviation",
        'post_name'                 => "post nom",
        'sending_city'              => "ville d'envoi",
        'receiving_city'            => "ville de réception",
        'company_name'              => "raison sociale",
        'contact'                   => "contact",
        'sending_currency'          => "devise d'envoi",
        'receiving_currency'        => "devise de réception",
        'transfer_fee_currency'     => "devise des frais de transfert",
