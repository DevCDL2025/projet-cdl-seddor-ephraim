...
import PositionForm from "@/App/Pages/Position/Components/PositionForm.vue";
...
import DepartmentTypeForm from "@/App/Pages/DepartmentType/Components/DepartmentTypeForm.vue";
    ...
    >
        ...
        <back-office-card>
            <template #card_header>
                ...
                <create-button-link
                    @click.prevent="openFormDialog(null)"
                    preserve-state
                    preserve-scroll
                    type="button"
                    :resource="viewElements.resource"
