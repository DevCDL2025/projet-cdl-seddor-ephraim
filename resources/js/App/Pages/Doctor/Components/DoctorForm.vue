                ...
                <div class="col-12 col-md-5">
                    <back-office-card>
                        ...
                        <div class="form-group mb-3">
                            <label for="" class="form-label mb-2 text-capitalize">{{ trans_choice('displays.resource.speciality', 2) }}</label>
                            ...
                            <div v-if="form.errors.speciality" class="form-error">{{ form.errors.speciality }}</div>
                        </div>
