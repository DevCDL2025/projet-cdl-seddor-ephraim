        ...
        <div class="form-container vertical">
            <div class="row d-flex justify-content-center">
                <div class="col-12 col-md-3">
                    <back-office-card>
                        ...
                        <select-field
                            ...
                            :error="form.errors.department_type"
                            :label="trans_choice('displays.resource.department-type', 2)"
                            required
                        >
                            <option v-for="data in departmentTypes" :key="data.id" :value="data.id">{{ data.label }}</option>
                        </select-field>
                ...
                <div class="col-12 col-md-9">
                    <back-office-card>
                        <template #card_header>
                            <p class="card-title h4 pb-0 mb-0 fw-bold">{{ trans_choice('displays.resource.speciality', 2) }}</p>
                        </template>
                        ...
                        <div class="row d-flex justify-content-end">
                            <div
                                v-for="data in specialities.data"
                            ...
                            <div class="col-12">
                                <back-office-pagination
                                    :paginator="specialities.meta"
                                    :links="specialities.meta.links"
                                    :details="true"
                                />
                            </div>
                        </div>
